        ...
        <main>
            ...
            <div class="search"> <!-- 검색기능 -->
                <form action="list.php" method="get">
                    <div>
                        <input type="search" placeholder="<?=$search_txt?>" name="search_txt"> <!-- 재귀함수처럼 내가 내 자신한테 다시한번 호출. 위에서 받는다 -->
                ...
                <table>
                    ...
                    <tbody>                    
                        <?php foreach($list as $item) { ?>
                            <tr>
                                <td><?=$item["i_board"]?></td>
                                <td class="title"><a href="detail.php?i_board=<?=$item["i_board"]?>&page=<?=$page?>"><?=$item["title"]?></a></td>
                                <td><?=$item["nm"]?></td>
